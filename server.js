...
accessories:[
  ...
  p('pioneer-gc-belt','Pioneer General Cut Belt','Pioneer Fitness',115,'Pioneer Fitness','https://www.pioneerfitness.net/collections/powerlifting-belts',9.1,4.9,890,'Pioneer Fitness','Handcrafted in USA — custom sizing available, exceptional quality.','Barbend',{'Thickness':'10mm','Width':'4"','Closure':'Prong','Material':'Leather','Custom Sizing':'Yes'},['Handcrafted USA','Custom Sizes','Premium Leather']),
  p('gymreapers-belt','Quick Locking Belt','Gymreapers',59,'Amazon','https://www.amazon.com/s?k=Gymreapers+quick+locking+belt&tag=gymgearcompar-20',8.5,4.7,12000,'Amazon','Best budget lever belt — premium feel at half the price.','Barbend',{'Thickness':'10mm','Width':'4"','Closure':'Quick-Lock','Material':'Leather','Nylon Option':'Yes'},['Best Budget','Quick-Lock','Great Value'],{salePrice:49}),
  p('harbinger-padded-straps','Padded Cotton Lifting Straps','Harbinger',15,'Amazon','https://www.amazon.com/s?k=Harbinger+padded+lifting+straps&tag=gymgearcompar-20',8.4,4.7,28000,'Amazon','Best-selling lifting straps — padded wrist, super comfortable.','Barbend',{'Material':'Cotton','Length':'21.5"','Padding':'Yes','Wrist Width':'2"','Washable':'Yes'},['Best Seller','Padded Wrist','Most Popular']),
  p('versa-gripps-pro','Versa Gripps PRO','Versa Gripps',60,'Amazon','https://www.amazon.com/s?k=Versa+Gripps+PRO&tag=gymgearcompar-20',9.0,4.8,6500,'Amazon','The most secure grip aid — no wrapping, instant release.','Garage Gym Reviews',{'Material':'Anti-Slip Polymer','Closure':'Quick Release','Wrist Support':'Yes','Sweat Resistant':'Yes','Patent':'Patented'},['No Wrapping','Quick Release','Patented Design']),
  p('sbd-wrist-wraps','Wrist Wraps','SBD',65,'SBD','https://www.sbdapparel.com/collections/wrist-wraps',9.4,4.9,3100,'SBD','Used by the world\'s top powerlifters — stiff, IPF approved.','Barbend',{'Stiffness':'Stiff','Length':'50cm','IPF Approved':'Yes','Material':'Cotton/Elastic','Warranty':'5 Year'},['IPF Approved','Competition Grade','Extremely Stiff']),
  p('frictionlabs-chalk','Unicorn Dust Chalk','Friction Labs',20,'Friction Labs','https://frictionlabs.com/products/unicorn-dust',9.2,4.9,7800,'Friction Labs','Best loose chalk available — used by Olympic athletes worldwide.','Barbend',{'Type':'Loose','Weight':'250g','Purity':'Ultra-Pure','Format':'Loose Powder','Pro Use':'Yes'},['Elite Athletes','Ultra Pure','Best Grip']),
],
