...
benches:[
  ...
  p('bells-bench','Utility Bench 2.0','Bells of Steel',329,'Bells of Steel','https://www.bellsofsteel.com/products/flat-utility-bench',9.0,4.8,201,'Bells of Steel','Lifetime warranty and grippy pad that rivals Rogue.','Garage Gym Lab',{'Capacity':'1,000 lbs','Pad':'Grippy Vinyl','Type':'Flat','Warranty':'Lifetime','Tripod':'Yes'},['Lifetime Warranty','Tripod Design','Grippy Pad']),
...
barbells:[
  ...
  p('bells-power-bar','Powerlifting Bar 2.0','Bells of Steel',299,'Bells of Steel','https://www.bellsofsteel.com/products/powerlifting-bar',9.2,4.9,1800,'Bells of Steel','Best Rogue alternative  --  Canadian made, aggressive knurl, great for powerlifting.',"Garage Gym Reviews",{'Weight':'20 kg','Shaft':'29mm','PSI':'190,000','Knurl':'Aggressive','Made In':'Canada'},['Canadian Made','Rogue Alternative','190k PSI']),
...
racks:[
  ...
  p('rep-pr5000','PR-5000 Power Rack','Rep Fitness',695,'Rep Fitness','https://repfitness.com/products/pr-5000-power-rack-pre-selected',9.1,4.8,445,'Rep Fitness','Best value full power rack  --  1" hole spacing, huge ecosystem.','Garage Gym Lab',{'Frame':'3×3" 11ga','Uprights':'90"','Hole Spacing':'1"','Weight':'270 lbs','Warranty':'Lifetime'},['Best Value','1" Spacing','Huge Ecosystem'],{salePrice:595}),
...
preworkout:[
  ...
  p('alani-pre','Pre-Workout','Alani Nu',44,'Alani Nu','https://alaninu.com/products/pre-workout-cosmic-stardust',8.2,4.7,21000,'Alani Nu','Best women-focused pre-workout  --  great taste, smooth energy.','Shape Magazine',{'Caffeine':'200mg','L-Citrulline':'6g','Beta-Alanine':'1.6g','Servings':'30','Focus':'Women'},['Women Focused','Great Taste','Smooth Energy']),
...
vitamins:[
  ...
  p('ritual-men','Essential for Men','Ritual',45,'Ritual','https://www.ritual.com/products/essential-multivitamin-for-men',8.7,4.7,8900,'Ritual','Minimal ingredient multivitamin with full traceability.','Wirecutter',{'Servings':'30 capsules','Traceable':'Yes','Delayed Release':'Yes','Non-GMO':'Yes','Vegan':'Yes'},['Traceable Ingredients','Delayed Release','Clean Formula']),
...
belts:[
  p('inzer-forever-belt','Forever Lever Belt','Inzer',129,'Inzer','https://inzer.com/products/forever-lever-lifting-belt%E2%84%A2-10mm',9.6,4.9,4200,'Inzer','The gold standard powerlifting belt  --  used by world record holders.','Barbend',{'Thickness':'10mm','Width':'4"','Closure':'Lever','Material':'Leather','IPF Approved':'Yes'},['IPF Approved','10mm Thick','Lever Buckle'],{bestChoice:true}),
  ...
  p('bells-lever-belt','Lever Belt 10mm','Bells of Steel',89,'Bells of Steel','https://www.bellsofsteel.com/products/lever-belt',8.9,4.8,760,'Bells of Steel','Canadian-made lever belt with lifetime warranty at a fair price.','Garage Gym Lab',{'Thickness':'10mm','Width':'4"','Closure':'Lever','Material':'Leather','Warranty':'Lifetime'},['Lifetime Warranty','Canadian Made','Lever Buckle']),
],
...
jumpropes:[
  p('rx-smart-gear-rope','Elite EVO Jump Rope','RX Smart Gear',59,'RX Smart Gear','https://www.rxsmartgear.com/products/evo-g2-rxsg-jump-rope',9.3,4.8,4200,'Barbend','Best rope for double-unders  --  weighted handles, customizable cable length.','Barbend',{'Handle':'Weighted','Cable':'Steel','Bearings':'Sealed','Customizable':'Yes','Best For':'Double Unders'},['Best for DUs','Weighted Handles','Customizable'],{bestChoice:true}),
